...
<body>
		...
		<div style="padding:0 20px">
			<div style="margin-bottom:10px">
				<input id="loginName" class="easyui-textbox" data-options="prompt:'用户名',iconCls:'icon-man'" style="width:100%;height:38px">
			</div>
			<div>
				<input id="loginPwd" class="easyui-passwordbox" data-options="prompt:'密码'" style="width:100%;height:38px">
			</div>
			<div style="text-align:center;margin-top:30px">
				<a href="javascript:void(0)" onclick="doLogin()" class="easyui-linkbutton c6 l-btn l-btn-small easyui-fluid" style="width:100%;height:40px"><span style="font-size:16px">登录</span></a>
			</div>
		</div>
	</div>
</body>	
